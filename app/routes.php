...
$app->post('/create-shared-folder', 'SlimApp\Controller\FolderController:createSharedFolder');
...
$app->post('/deleteSharedFolder', 'SlimApp\Controller\FolderController:deleteSharedFolder');
...
$app->post('/deleteSharedFile', 'SlimApp\Controller\FileController:deleteSharedFile');
$app->post('/renameSharedFile', 'SlimApp\Controller\FileController:renameSharedFile');
